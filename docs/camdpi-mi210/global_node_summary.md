...
| `auh7-1b-gpu-227` | `297`; 4/8/16-node groups | Healthy | With `297`: all-reduce 1 MiB `0.65 ms`, 64 MiB `23.65 ms`. Healthy 8-node set `76346`: all-reduce 1 MiB `1.05 ms`, 64 MiB `35.32 ms`. |
...
| `auh7-1b-gpu-267` | `268`, `275`, `200`; 4/8/16-node groups | Healthy | With `268`: all-reduce 1 MiB `0.579 ms`, 64 MiB `13.27 ms`. With `200`: all-reduce 1 MiB `0.683 ms`. `275` failure was isolated to `275`. |
| `auh7-1b-gpu-268` | `267`, `276`, `206`; 4/8/16-node groups | Healthy | With `267`: all-reduce 1 MiB `0.579 ms`, 64 MiB `13.27 ms`. `276` failure was isolated to `276`; `206` failure was isolated to `206`. |
| `auh7-1b-gpu-269` | `270`, `282`, `319`; 4/8/16-node groups | Healthy | With `270`: all-reduce 1 MiB `0.58 ms`, 64 MiB `12.89 ms`, ring p2p 64 MiB `31.75 ms`. Failures with `282` and `319` were isolated to those peers. |
| `auh7-1b-gpu-270` | `269`, `287`, `320`; 4/8/16-node groups | Healthy | With `287`: all-reduce 1 MiB `0.580 ms`, 64 MiB `13.27 ms`. With `320`: all-reduce 1 MiB `0.672 ms`, 64 MiB `25.66 ms`. |
...
| `auh7-1b-gpu-286` | `296`; 8/16-node groups | Healthy | With `296`: all-reduce 1 MiB `0.637 ms`, 64 MiB `24.14 ms`. Healthy 8-node set `76346`: all-reduce 1 MiB `1.05 ms`, 64 MiB `35.32 ms`. |
...
| `auh7-1b-gpu-296` | `286`; 8/16-node groups | Healthy | With `286`: all-reduce 1 MiB `0.637 ms`, 64 MiB `24.14 ms`. Healthy 8-node set `76346`: all-reduce 1 MiB `1.05 ms`, 64 MiB `35.32 ms`. |
| `auh7-1b-gpu-297` | `227`; 8/16-node groups | Healthy | With `227`: all-reduce 1 MiB `0.653 ms`, 64 MiB `23.65 ms`. Healthy 8-node set `76346`: all-reduce 1 MiB `1.05 ms`, 64 MiB `35.32 ms`. |
